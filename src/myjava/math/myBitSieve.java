/*
 * @(#)myBitSieve.myjava	1.6 00/02/02
 *
 ...
 * be constant to reduce overhead. All the bits of a new myBitSieve are zero, and
...
class myBitSieve {
    /**
     * Stores the bits in this myBitSieve.
     */
    private long bits[];
     ...
     * sieve.
     */
    private static myBitSieve smallSieve = new myBitSieve();

    /**
     * Construct a "small sieve" with a base of 0.  This constructor is 
     * used internally to generate the mySet of "small primes" whose multiples
     * are excluded from sieves generated by the main (package private)
     * constructor, myBitSieve(myBigInteger base, int searchLen).  The length
     ...
     * be even.
     */
    myBitSieve(myBigInteger base, int searchLen) {
        /*
         * Candidates are indicated by clear bits in the sieve. As a candidates
         * nonprimality is calculated, a bit is mySet in the sieve to eliminate
    ...
    /**
     * mySet the bit at the specified index.
     */
    private void mySet(int bitIndex) {
        int unitIndex = unitIndex(bitIndex);
    ...
    /**
     * Sieve a single mySet of multiples out of the sieve. Begin to remove
